  ...
  return (
    <section id="orari" className="py-24">
      <div className="container mx-auto px-4">
        ...
        >
          <span className="text-sm uppercase tracking-widest text-primary mb-4">{t.hours.label}</span>
          <h2 className="font-serif text-4xl md:text-5xl mb-12 text-center">{t.hours.title}</h2>
